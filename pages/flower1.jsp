...
<body>
            ...
            if (Star != null && Content != null && !Star.isEmpty() && !Content.isEmpty()) {
                ...
                try {
                    ...
                    if (starValue < 1 || starValue > 5) {
                        throw new NumberFormatException("Star value out of range");
                    }

                    // 執行 SQL 指令
                    String sql = "INSERT INTO message (MemberID, ProductID, Content, Star, MessageTime) VALUES (?, '001', ?, ?, ?)";
                    pstmt = con.prepareStatement(sql);
                    
                    // 設置參數
                    pstmt.setString(1, MemberID);
                    pstmt.setString(2, Content);
                    pstmt.setInt(3, starValue);
    ...
    <div class="container">
        ...
        <div class="review-form">
            <form action="#" name="contact" method="post" accept-charset="UTF-8">
            ...
            <ul>
                <%
                    ...
                    try {
                        ...
                        // 查詢評論
                        String query = "SELECT Content, Star FROM message WHERE ProductID = '001' ORDER BY MessageTime DESC";
    ...
    <a href="index.jsp" style="text-align: center; display: block;">
        <input type="button" value="回首頁" id="button" class="bt">
    </a>
