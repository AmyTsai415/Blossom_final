...
<body>
    <%
        ...
        String Content = request.getParameter("Content"); // 使用字符串保存评价内容
        ...
        try {
            ...
            // 執行 SQL 指令
            String sql = "INSERT INTO message (MemberID, ProductID, Content, Star, MessageTime) VALUES (?, '006', ?, ?, ?)";
            ...
            <ul>
                <%
                    ...
                    try {
                        ...
                        // 查詢評論
                        String query = "SELECT Content, Star FROM message WHERE ProductID = '006' ORDER BY MessageTime DESC";
