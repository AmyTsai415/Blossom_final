...
<body>
    <%
        ...
        try {
            ...
            // 執行 SQL 指令
            String sql = "INSERT INTO message (MemberID, ProductID, Content, Star, MessageTime) VALUES (?, '004', ?, ?, ?)";
            ...
            <ul>
                <%
                    ...
                    try {
                        ...
                        // 查詢評論
                        String query = "SELECT Content, Star FROM message WHERE ProductID = '004' ORDER BY MessageTime DESC";
